...
const propertyDetail = {
  ...
  baths: "3 Baths",
  sqft: "350 Sq.Mt.",
  description: `Rumah bergaya suburban di tengah kota Magelang. Menampilkan desain modern dengan nuansa alam, rumah ini menyediakan kenyamanan dan keindahan dengan ruang keluarga yang luas, dapur yang dilengkapi dengan baik, dan taman belakang yang indah, memberikan suasana hangat dan menyambut.`,
};

const RumahDetail5: React.FC = () => {
  return (
    <div
