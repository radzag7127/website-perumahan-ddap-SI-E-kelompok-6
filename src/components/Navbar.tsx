...
import GRIYAlogo from "../../public/logo-rahayu.svg";
    ...
    <>
      ...
      >
        <Link
          ...
          href={"/"}
          className="relative h-12 w-12 hover:text-blue-500"
        >
          <Image
            src={GRIYAlogo}
            alt="logo griya"
      ...
      <motion.div
        ...
        className="w-2/3 bg-white shadow-md h-screen p-5 fixed right-0 z-30 text-black"
      >
        ...
        <div className="flex flex-col mt-10">
          <Link
            href={"/"}
            className="flex items-center justify-end border-b gap-5 py-4 text-black hover:text-green-700"
          >
            <span>Beranda</span>
